...
describe('Model: AgeGroup', () => {
    it('should create a group', () => {
        const ag = new AgeGroup(1, 20);
        expect(ag.code).toBe(1);
        expect(ag.cutoff).toBe(20);
    });

    it('should return a formatted string', () => {
        const ag = new AgeGroup(0, 42);
    ...
    describe('equals', () => {
        it('should succeed on the same gender', () => {
            const r1 = new AgeGroup(1, 10);
            const r2 = new AgeGroup(1, 10);
